...
"Ruby on Rails based Example App":http://github.com/aq1018/jquery.swfuploader.example
...
jquery.swfuploader does very little by itself. It is like a manager that delegates work to *sets* such as MultiFile or ExampleSet.
...
* The MultiFile is a UI that mimics Flickr upload.
...
This parameter is an extension to the SWFUpload initialization options.
